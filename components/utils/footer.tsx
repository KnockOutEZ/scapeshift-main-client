                     ...
                     <div className="col-xl-5 col-lg-5 col-md-7 col-sm-12">
                         <div className="single-footer-caption">
                             <div className="single-footer-caption">
                                 ...
                                 <div className="footer-social" style={{color:"white"}}>
                                 ...
                                 <div className="footer-form" >
                                     <div id="mc_embed_signup">
                                         ...
                                         method="get" className="subscribe_form relative mail_part">
                                             ...
                                             className="email_icon newsletter-submit button-contactForm"><img src="assets/img/logo/form-iocn.png" alt=""/></button>
                                             </div>
                ...
                <div className="footer-border">
                     <div className="row d-flex align-items-center justify-content-between">
                         <div className="col-lg-6">
                             <div className="footer-copy-right" style={{color:"white"}}>
